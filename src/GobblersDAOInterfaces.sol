...
/// @title Gobblers DAO Logic interfaces and events

// LICENSE
// GobblersDAOInterfaces.sol is a modified version of Compound Lab's GovernorBravoInterfaces.sol:
...
contract GobblersDAOEvents {
    ...
    /// @notice An event emitted when a proposal has been queued in the GobblersDAOExecutor
    event ProposalQueued(uint256 id, uint256 eta);

    /// @notice An event emitted when a proposal has been executed in the GobblersDAOExecutor
...
contract GobblersDAOProxyStorage {
...
/**
 * @title Storage for Governor Bravo Delegate
 * @notice For future upgrades, do not change GobblersDAOStorageV2. Create a new
...
interface IGobblersDAOExecutor {
