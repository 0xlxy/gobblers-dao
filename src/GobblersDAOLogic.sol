...
contract GobblersDAOLogicV2 is GobblersDAOStorageV2, GobblersDAOEventsV2 {
    ...
    function initialize(
        ...
        require(address(timelock) == address(0), 'GobblersDAO::initialize: can only initialize once');
        if (msg.sender != admin) {
            revert AdminOnly();
        }
        ...
        require(
            ...
            'GobblersDAO::initialize: invalid voting delay'
        );
        require(
            proposalThresholdBPS_ >= MIN_PROPOSAL_THRESHOLD_BPS && proposalThresholdBPS_ <= MAX_PROPOSAL_THRESHOLD_BPS,
            'GobblersDAO::initialize: invalid proposal threshold bps'
        );
    ...
    function propose(
        ...
        require(
            ...
            'GobblersDAO::propose: proposal function information arity mismatch'
        );
        require(targets.length != 0, 'GobblersDAO::propose: must provide actions');
        require(targets.length <= proposalMaxOperations, 'GobblersDAO::propose: too many actions');
        ...
        if (temp.latestProposalId != 0) {
            ...
            require(
                ...
                'GobblersDAO::propose: one live proposal per proposer, found an already active proposal'
            );
            require(
                proposersLatestProposalState != ProposalState.Pending,
                'GobblersDAO::propose: one live proposal per proposer, found an already pending proposal'
            );
        }
    ...
    function queue(uint256 proposalId) external {
        require(
            ...
            'GobblersDAO::queue: proposal can only be queued if it is succeeded'
        );
    ...
    function queueOrRevertInternal(
        ...
        require(
            ...
            'GobblersDAO::queueOrRevertInternal: identical proposal action already queued at eta'
        );
    ...
    function execute(uint256 proposalId) external {
        require(
            ...
            'GobblersDAO::execute: proposal can only be executed if it is queued'
        );
        Proposal storage proposal = _proposals[proposalId];
    ...
    function state(uint256 proposalId) public view returns (ProposalState) {
        require(proposalCount >= proposalId, 'GobblersDAO::state: invalid proposal id');
        Proposal storage proposal = _proposals[proposalId];
        if (proposal.vetoed) {
    ...
    function castVoteBySig(
        ...
        require(signatory != address(0), 'GobblersDAO::castVoteBySig: invalid signature');
    ...
    function castVoteInternal(
        ...
        require(state(proposalId) == ProposalState.Active, 'GobblersDAO::castVoteInternal: voting is closed');
        require(support <= 2, 'GobblersDAO::castVoteInternal: invalid vote type');
        Proposal storage proposal = _proposals[proposalId];
    ...
    function _setVotingDelay(uint256 newVotingDelay) external {
        ...
        require(
            ...
            'GobblersDAO::_setVotingDelay: invalid voting delay'
        );
    ...
    function _setVotingPeriod(uint256 newVotingPeriod) external {
        ...
        require(
            ...
            'GobblersDAO::_setVotingPeriod: invalid voting period'
        );
    ...
    function _setProposalThresholdBPS(uint256 newProposalThresholdBPS) external {
        ...
        require(
            ...
            'GobblersDAO::_setProposalThreshold: invalid proposal threshold bps'
        );
    ...
    function _setMinQuorumVotesBPS(uint16 newMinQuorumVotesBPS) external {
        ...
        require(
            ...
            'GobblersDAO::_setMinQuorumVotesBPS: invalid min quorum votes bps'
        );
        require(
            newMinQuorumVotesBPS <= params.maxQuorumVotesBPS,
            'GobblersDAO::_setMinQuorumVotesBPS: min quorum votes bps greater than max'
        );
    ...
    function _setMaxQuorumVotesBPS(uint16 newMaxQuorumVotesBPS) external {
        ...
        require(
            ...
            'GobblersDAO::_setMaxQuorumVotesBPS: invalid max quorum votes bps'
        );
        require(
            params.minQuorumVotesBPS <= newMaxQuorumVotesBPS,
            'GobblersDAO::_setMaxQuorumVotesBPS: min quorum votes bps greater than max'
        );
    ...
    function _setPendingAdmin(address newPendingAdmin) external {
        // Check caller = admin
        require(msg.sender == admin, 'GobblersDAO::_setPendingAdmin: admin only');
    ...
    function _acceptAdmin() external {
        ...
        require(msg.sender == pendingAdmin && msg.sender != address(0), 'GobblersDAO::_acceptAdmin: pending admin only');
    ...
    function _burnVetoPower() public {
        ...
        require(msg.sender == vetoer, 'GobblersDAO::_burnVetoPower: vetoer only');
     ...
     * @param totalSupply The total supply of Gobblers at the time of proposal creation
    ...
    function getDynamicQuorumParamsAt(uint256 blockNumber_) public view returns (DynamicQuorumParams memory) {
        uint32 blockNumber = safe32(blockNumber_, 'GobblersDAO::getDynamicQuorumParamsAt: block number exceeds 32 bits');
