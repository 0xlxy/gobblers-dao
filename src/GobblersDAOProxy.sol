...
/// @title The Gobblers DAO proxy contract for V2

// GobblersDAOProxyV2.sol is a modified version of GobblersDAOProxy.sol, tailored for the DAO's V2.
// Its main purpose is to support people wishing to deploy V2 directly, without having to deploy V1 first and then upgrade.

// LICENSE
// GobblersDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// GobblersDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract GobblersDAOProxyV2 is GobblersDAOStorageV2, GobblersDAOEvents {
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'GobblersDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'GobblersDAOProxy::_setImplementation: invalid implementation address');
